...
wav=[0.2316,0.3040,0.3932,0.5332,0.7016,1.0101,1.2705,1.4625,1.7840,2.0460,2.3250,2.7885,3.4615,8.0205]
...
if (iwrite eq 1) then begin
 ...
 ;outputfile=outputdir+'ecearth3.2'+'_'+modelname+'_'+simulation_id+'_'+vertical+'_'+time_string+'_monthly_v1.2_'+levels_id1+'.nc'
