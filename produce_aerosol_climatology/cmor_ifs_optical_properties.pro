...
;      'mmr_no3','mmr_nh4'] ;,'mmr_msa']
 ...
 outputfile=outputdir+'tm5_clim_pio_aerosol_opt_'+levels_id1+'.nc'
 ; outputfile=outputdir+'tm5_clim_pic_aerosol_opt_'+levels_id1+'.nc'
 ; outputfile=outputdir+'tm5_clim_piz_aerosol_opt_'+levels_id1+'.nc'
 ; outputfile=outputdir+'tm5_clim_mh1_aerosol_opt_'+levels_id1+'.nc'
