...
; Modify these for different purposes:
; 1. outputdir
; 2. nlon, nlat, nlev_tm5, nlev_ece, nmonth
; 3. two places, one for tm5 (in), and one for ece (out): hybrid coordinates from griddef file
;    you can also use 'get_grid' to get the grid settings
; 4. nyear, year_start
; 5. inputdir, simulation_id
; 6. check the file name for aerocom3 and mmix: af, mf
; 7. outputfile
...
nlev_ece=62 ; 60, 62, 91, 137 (previously 34, out of 60, Twan did not include 60, I do not know if it will work here)
nwav=14
...
; !dtor: system defined variable degree to radian
dxx=dlon*!dtor
dyy=dlat*!dtor
xlat=-90.*!dtor
...
for year = year_start,year_end do begin
  ...
  for month = 1,nmonth do begin
    ...
    ; In the file data.ps is [ntime, nlat, nlon], so we need to squeeze (ntime=1) and then rotate it
    ...
    ; SOA added separately in new model version
    get_tm5_hdf, mf, tracer="SOAAIS", data=data, stat=rc
    rotate_3d, nlon, data, help_3d
    ais_oammr[*,*,*,month-1]=ais_oammr[*,*,*,month-1]+help_3d[*,*,*]
    ...
    ; SOA added separately in new model version
    get_tm5_hdf, mf, tracer="SOAACS", data=data, stat=rc
    rotate_3d, nlon, data, help_3d
    acs_oammr[*,*,*,month-1]=acs_oammr[*,*,*,month-1]+help_3d[*,*,*]
    ...
    ; SOA added separately in new model version
    get_tm5_hdf, mf, tracer="SOACOS", data=data, stat=rc
    rotate_3d, nlon, data, help_3d
    cos_oammr[*,*,*,month-1]=cos_oammr[*,*,*,month-1]+help_3d[*,*,*]
    ...
    ; SOA added separately in new model version
    get_tm5_hdf, mf, tracer="SOAAII", data=data, stat=rc
    rotate_3d, nlon, data, help_3d
    aii_oammr[*,*,*,month-1]=aii_oammr[*,*,*,month-1]+help_3d[*,*,*]
...
;===================================================================;
; Starting to set ece input data file
;===================================================================;
...
if (iwrite eq 1) then begin
  ...
  var_filenames=['nconc_nus','mmrso4_nus',$
 ...
 ;outputfile=outputdir+'ecearth3.2'+'_'+modelname+'_'+simulation_id+'_'+vertical+'_'+time_string+'_monthly_v1.2_'+levels_id1+'_aerosol-concentrations.nc'
 ;outputfile=outputdir+'tm5_clim_pi_aerosol_conc_v1.2_'+levels_id1+'.nc'
 ;outputfile=outputdir+'tm5_clim_pi_aerosol_conc_v2.0_'+levels_id1+'.nc'
 ;outputfile=outputdir+'tm5_clim_pi_aerosol_conc_v3.0_'+levels_id1+'.nc'
 ;outputfile=outputdir+'tm5_clim_pd_aerosol_conc_v3.0_'+levels_id1+'.nc'
 ;outputfile=outputdir+'tm5_clim_pi_aerosol_v1.2_'+levels_id1+'.nc'
 ;outputfile=outputdir+'tm5_clim_pi_aerosol_conc_v4.0_'+levels_id1+'.nc'
 ;outputfile=outputdir+'tm5_clim_pi_aerosol_conc_v5.0_153'+levels_id1+'.nc'
 ;outputfile=outputdir+'tm5_clim_pi_aerosol_conc_v5.0_155'+levels_id1+'.nc'
 ...
 varnames=[varnames_2d,'time','time_bnds',varnames_3d,var_filenames]
 ;varnames=[var_filenames]
